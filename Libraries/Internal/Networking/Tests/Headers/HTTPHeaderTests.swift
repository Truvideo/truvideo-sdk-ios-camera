...
struct HTTPHeaderTests {
    ...
    @Test func testThatHeaderInitialization() {
        // Given
    ...
    @Test func testThatAcceptLanguageHeader() {
        // Given
    ...
    @Test func testThatDefaultAcceptLanguageHeader() {
        // Given
    ...
    @Test func testThatAuthorizationLanguageHeader() {
        // Given
    ...
    @Test func testThatBearerTokenHeader() {
        // Given
        let sut = HTTPHeader.bearerToken("foo")
        
        // When, Then
        #expect(sut.name == "Authorization", "Expected name to be equals to Authorization")
        #expect(sut.value == "Bearer foo", "Expected value to be equals to => Bearer foo")
    }
    
    @Test func testThatContentTypeHeader() {
        // Given
        let sut = HTTPHeader.contentType("foo")
        
        // When, Then
        #expect(sut.name == "Content-Type", "Expected name to be equals to Content-Type")
        #expect(sut.value == "foo", "Expected value to be equals to foo")
    }
}
