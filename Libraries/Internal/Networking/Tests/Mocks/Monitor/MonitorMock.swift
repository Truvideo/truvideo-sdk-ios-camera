...
public final class MonitorMock: Monitor, @unchecked Sendable {
    ...
    public var requestIsRetryingCallback: ((Request) -> Void)?
    ...
    public func request<Value>(_ request: DataRequest, didParseResponse response: Response<Value, NetworkingError>) {
