...
struct CompositeMonitorTests {
    ...
    @Test func testThatRequestDidResumeShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didResumeCallCount == 1, "Expect didResumeCallCount to be 1")
    }
    
    @Test func testThatDidCancelShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCancelCallCount == 1, "Expect didCancelCallCount to be 1")
    }
    
    @Test func testThatRequestDidFinishShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didFinishCallCount == 1, "Expect didFinishCallCount to be 1")
    }
    
    @Test func testThatDidSuspendShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didSuspendCallCount == 1, "Expect didSuspendCallCount to be 1")
    }
    
    @Test func testThatRequestIsPreparingShouldCallMonitors() async {
        // Given
        let monitor = MonitorMock()
        let sut = CompositeMonitor(monitors: [monitor, CustomMonitor()])
        ...
        // Then
        #expect(monitor.requestIsPreparingCallCount == 1, "Expect requestIsPreparingCallCount to be 1")
    }

    @Test func testThatRequestIsRetryingShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(requestIsRetryingCallCount == 1, "Expect requestIsRetryingCallCount to be 1")
    }
    
    @Test func testThatRequestDidParseResponseShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didParseResponseCallCount == 1, "Expect didParseResponseCallCount to be 1")
    }

    @Test func testThatRequestDidParseResponseObjectShouldCallMonitors() async {
        // Given
        var didParseResponseCallCount = 0
        let monitor = MonitorMock()
        let sut = CompositeMonitor(monitors: [monitor, CustomMonitor()])
    ...
    @Test func testThatRequestDidCollectMetricsShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCollectMetricsCallCount == 1, "Expect didParseResponseCallCount to be 1")
    }

    @Test func testThatRequestDidCompleteTaskShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCompleteTaskCallCount == 1, "Expect didCompleteTaskCallCount to be 1")
    }

    @Test func testThatRequestDidCreateSessionTaskShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCreateTaskCallCount == 1, "Expect didCreateTaskCallCount to be 1")
    }
    
    @Test func testThatRequestDidCreateURLRequestShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCreateURLRequestCallCount == 1, "Expect didCreateURLRequestCallCount to be 1")
    }

    @Test func testThatRequestDidFailToCreateURLRequestShouldCallMonitors() async throws {
        // Given
        ...
        // Then
        #expect(didFailToCreateURLRequestCallCount == 1, "Expect didFailToCreateURLRequestCallCount to be 1")
    }
    
    @Test func testThatRequestDidFailToInterceptURLRequestShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didFailToInterceptURLRequestCallCount == 1, "Expect didFailToInterceptURLRequestCallCount to be 1")
    }
    
    @Test func testThatRequestDidInterceptURLRequestShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didInterceptURLRequestlCallCount == 1, "Expect didInterceptURLRequestlCallCount to be 1")
    }

    @Test func testThatRequestDidValidateRequestShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didValidateRequestCallCount == 1, "Expect didValidateRequestCallCount to be 1")
    }

    @Test func testThatDidFailToInterceptURLRequestShouldCallMonitors() async {
        // Given
        var didFailToInterceptURLRequestCallCount = 0
        let monitor = MonitorMock()
        let sut = CompositeMonitor(monitors: [monitor, CustomMonitor()])
    ...
    @Test func testThatRequestDidCancelTaskShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCancelTaskCallCount == 1, "Expect didCancelTaskCallCount to be 1")
    }

    @Test func testThatRequestIsFinishingShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(requestIsFinishingCallCount == 1, "Expect requestIsFinishingCallCount to be 1")
    }
    
    @Test func testThatRequestDidFailTaskWithErrorShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didFailTaskWithErrorCallCount == 1, "Expect didFailTaskWithErrorCallCount to be 1")
    }
    
    @Test func testThatRequestDidResumeTaskShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didResumeTaskCallCount == 1, "Expect didResumeTaskCallCount to be 1")
    }
    
    @Test func testThatRequestDidSuspendTaskShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didSuspendTaskCallCount == 1, "Expect didSuspendTaskCallCount to be 1")
    }
    
    @Test func testThatRequestDidCreateInitialURLRequestShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(didCreateInitialURLRequestCallCount == 1, "Expect didCreateInitialURLRequestCallCount to be 1")
    }
    
    @Test func testThatSessionDataTaskDidReceiveDataShouldCallMonitors() async {
        // Given
        ...
        // Then
        #expect(sessionDataTaskDidReceiveDataCallCount == 1, "Expect sessionDataTaskDidReceiveDataCallCount to be 1")
    }
    
    @Test func testThatSessionDataTaskDidReceiveResponseShouldCallMonitors() async {
        // Given
    ...
    @Test func testThatSessionDataTaskDidBecomeInvalidWithErrorShouldCallMonitors() async {
        // Given
    ...
    @Test func testThatSessionDataTaskDidCompleteWithErrorShouldCallMonitors() async {
        // Given
        ...
        #expect(
            sessionDataTaskDidCompleteWithErrorMetricsCallCount == 1,
            "Expect sessionDataTaskDidCompleteWithErrorMetricsCallCount to be 1"
        )
    }
    
    @Test func testThatSessionDataTaskDidFinishCollectingMetricsShouldCallMonitors() async {
        // Given
        ...
        #expect(
            sessionDataTaskDidFinishCollectingMetricsCallCount == 1,
            "Expect sessionDataTaskDidFinishCollectingMetricsCallCount to be 1"
        )
    }
}
