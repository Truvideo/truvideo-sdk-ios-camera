...
struct RequestTests {
    ...
    func testThatDidCreateInitialRequestShouldCallMonitorAndAppendRequest() async {
        ...
        // Then
        #expect(sut.requests.count == 1, "Expected requests count to be equals to 1")
        #expect(
            monitor.requestDidCreateInitialURLRequestCallCount == 1,
            "Expected requestDidCreateInitialURLRequestCallCount to be equals to 1"
        )
    }
    ...
    func testThatDidCreateTaskShouldCallMonitorAndAppendTask() async {
        ...
        // Then
        #expect(sut.tasks.count == 1, "Expected tasks count to be equals to 1")
    ...
    func testThatDidCreateTaskWhenRequestIsCancelledShouldResumeAndCancelTheTask() async {
        ...
        // Then
        #expect(sut.tasks.count == 1, "Expected requests tasks to be equals to 1")
        #expect(monitor.requestDidCancelTaskCallCount == 1, "Expected requestDidCancelTaskCallCount to be equals to 1")
    }
    ...
    func testThatDidFailTaskShouldCallMonitorAndSetError() async {
        ...
        // Then
        #expect(sut.error?.kind == .explicitlyCancelled, "Expected error to be equals to explicitlyCancelled")
        #expect(sut.tasks.count == 0, "Expected requests tasks to be equals to 0")
    ...
    func testThatDidCreateURLRequestShouldCallMonitor() async {
        ...
        // Then
        #expect(
            monitor.requestDidCreateURLRequestCallCount == 1,
            "Expected requestDidCreateURLRequestCallCount to be equals to 1"
        )
    }
    ...
    func testThatDidFailToCreateURLRequestShouldCallMonitor() async {
        ...
        // Then
        #expect(sut.error?.kind == .explicitlyCancelled, "Expected error to be equals to explicitlyCancelled")
        #expect(monitor.requestDidFinishCallCount == 0, "Expected requestDidFinishCallCount to be equals to 0")
        #expect(
            monitor.didFailToCreateURLRequestWithErrorCallCount == 1,
            "Expected didFailToCreateURLRequestWithErrorCallCount to be equals to 1"
        )
    ...
    func testThatCancelShouldCallMonitorAndSetTheStateToCancelled() async {
        ...
        // Then
        #expect(sut.state == .cancelled, "Expected state to be equals to cancelled")
        #expect(monitor.requestDidCancelCallCount == 1, "Expected requestDidCancelCallCount to be equals to 1")
    }
    ...
    func testThatSuspendShouldCallMonitorAndSetTheStateToSuspended() async {
        ...
        // Then
        #expect(sut.state == .suspended, "Expected state to be equals to suspended")
    ...
    func testThatSuspendShouldCallMonitorAndSuspendTheTask() async {
        ...
        #expect(monitor.requestDidSuspendCallCount == 1, "Expected requestDidSuspendCallCount to be equals to 1")
        #expect(
            monitor.requestDidSuspendTaskCallCount == 1,
            "Expected requestDidSuspendTaskCallCount to be equals to 1"
        )
    }
    ...
    func testThatAppendResponseSerializerShouldResumeTheRequest() async {
        ...
        // Then
        #expect(sut.responseSerializers.count == 1, "Expected responseSerializers count to be equals to 1")
        #expect(sut.state == .resumed, "Expected state to be equals to resumed")
    }
