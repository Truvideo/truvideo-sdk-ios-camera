...
struct DecodableResponseSerializerTests {
    ...
    @Test func testThatSerializeShouldReturnAValidObject() throws {
        // Given
        ...
        // Then
        #expect(serializedObject == test, "Expected serializedObject to be equals to \(test)")
    }
    
    @Test func testThatSerializeShouldReturnEmptyOnCustomEmptyResponseCodes() throws {
        // Given
        ...
        // Then
        #expect(serializedObject == Empty.value, "Expected serializedObject to be an Empty instance")
    }
    
    @Test func testThatSerializeShouldThrowAnErrorIfSentErrorIsNotNil() throws {
        // Given
    ...
    @Test func testThatSerializeShouldThrowAnErrorIfDataIsEmptyAndStatusCodeIsNotAllowed() throws {
        // Given
        let response = HTTPURLResponse(url: url, statusCode: 500, httpVersion: nil, headerFields: nil)
        let sut = DecodableResponseSerializer<Test>()
    ...
    @Test func testThatSerializeShouldThrowAnErrorIfDataIsEmptyWithCustomEmptyResponseCodes() throws {
        // Given
    ...
    @Test func testThatSerializeShouldThrowAnErrorIfExpectedTypeIsNotValidForAnEmptyValue() throws {
        // Given
    ...
    @Test func testThatSerializeShouldThrowAnErrorIfDecoderIsNotAbleToDeserializeTheData() throws {
        // Given
