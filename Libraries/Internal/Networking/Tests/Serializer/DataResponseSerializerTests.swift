...
struct DataResponseSerializerTests {
    ...
    @Test func testThatSerializeShouldReturnValidData() throws {
        // Given
        ...
        // Then
        #expect(serializedObject == data, "Expected serializedObject to be equals to data")
    }
    
    @Test func testThatSerializeShouldReturnDataOnCustomEmptyResponseCodes() throws {
        // Given
