...
struct StringResponseSerializerTests {
    ...
    @Test func testThatSerializeShouldReturnAValidString() throws {
        // Given
        ...
        // Then
        #expect(serializedObject == "Foo", "Expected serializedObject to be equals to foo")
    }
    
    @Test func testThatSerializeShouldReturnAStringOnCustomEmptyResponseCodes() throws {
        // Given
        ...
        // Then
        #expect(serializedObject == "", "Expected serializedObject to be an empty String")
    }
    ...
    @Test func testThatSerializeShouldThrowAnErrorOnInvalidUTF8StringData() throws {
        // Given
