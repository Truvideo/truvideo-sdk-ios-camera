...
///
/// The `RequestDelegate` protocol provides methods for retrying failed requests,
...
public protocol RequestDelegate: AnyObject, Sendable {
    ...
    func retry(request: Request, failedWith error: NetworkingError) async -> RetryPolicy
}

/// Represents a network request and its lifecycle.
///
/// The `Request` class manages the execution, state, and retries of a network request.
