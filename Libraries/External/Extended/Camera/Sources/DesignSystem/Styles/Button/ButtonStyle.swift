...
extension ButtonStyle where Self == PrimaryButtonStyle {
    ...
    ///
    /// This method allows you to override the default theme colors with custom values
    /// while maintaining the primary button's visual characteristics.
    ///
    /// - Parameters:
    ///   - backgroundColor: The background color of the button. If `nil`, uses theme default.
    ///   - textColor: The text color of the button. If `nil`, uses theme default.
    /// - Returns: A `PrimaryButtonStyle` instance with the specified colors.
    ///
    /// ## Example Usage
    ///
    /// ```swift
    /// Button("Custom Primary", action: {})
    ///     .buttonStyle(.primary(backgroundColor: .blue, textColor: .white))
    /// ```
    public static func primary(backgroundColor: Color?, textColor: Color?) -> PrimaryButtonStyle {
...
public struct PrimaryButtonStyle: ButtonStyle {
    ...
    ///
    /// If `nil`, the style will use the theme's primary color. If provided,
    /// this color will be used instead of the theme default.
    let backgroundColor: Color?

    /// The text color of the button.
    ///
    /// If `nil`, the style will use the theme's onPrimary color. If provided,
    /// this color will be used instead of the theme default.
    let textColor: Color?
    ...
    public func makeBody(configuration: Configuration) -> some View {
        PrimaryButton(backgroundColor: backgroundColor, textColor: textColor, configuration: configuration)
    }
}
